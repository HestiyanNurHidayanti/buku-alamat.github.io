...
class AppComponent {
    constructor(dialog, // Menabahkan variable dialog
    api) {
        this.dialog = dialog;
        this.api = api;
        this.title = 'buku-alamat';
...
module.exports = __webpack_require__(/*! D:\tekweb1800016146\buku-alamat\src\main.ts */"./src/main.ts");
